...
<div class="x-body layui-anim layui-anim-up">
    <blockquote class="layui-elem-quote">欢迎管理员：
        <span class="x-red">${user.name}</span>！当前时间:<span id="time">2018-04-25 20:50:53</span></blockquote>
    ...
    <fieldset class="layui-elem-field">
        ...
        <div class="layui-field-box">
            <table class="layui-table" lay-skin="line">
                ...
                <tr>
                    <td >
                        <a class="x-a" href="/" target="_blank">新花上市-蓝色妖姬</a>
                    </td>
                </tr>
                <tr>
                    <td >
                        <a class="x-a" href="/" target="_blank">交流qq群:(782775942)</a>
                    </td>
                </tr>
                </tbody>
            </table>
    ...
    <fieldset class="layui-elem-field">
        ...
        <div class="layui-field-box">
            <table class="layui-table">
                ...
                <tr>
                    <th>开发者</th>
                    <td>史蒂夫(1332691109@qq.com)</td></tr>
                </tbody>
            </table>
        </div>
    </fieldset>
